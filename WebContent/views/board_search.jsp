...
<head>
    ...
    <style>
	    ...
	    .info .ellipsis {overflow: hidden;text-overflow: ellipsis;white-space: nowrap; margin: 4px;}
	    .info .jibun {font-size: 11px;color: #555;margin: 4px;}
	    .info .img {position: absolute;top: 6px;left: 5px;width: 73px;height: 71px;border: 1px solid #ddd;color: #888;overflow: hidden;}
	    .info:after {content: '';position: absolute;margin-left: -12px;left: 50%;bottom: 0;width: 22px;height: 12px;background: url('http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/vertex_white.png')}
	    .info .link {font-size: 12px; color: #5085BB;margin : 3px; float: right; bottom: 0;}
	</style>
...
$(document).ready(function() {
	$.get("/Spark/resources/json/data2.json", function(data) {
		...
		positions.forEach(function(pos) {
			...
			if(Search2==i){customOverlay.setMap(map);}
