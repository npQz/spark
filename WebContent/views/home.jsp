...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/format/header.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/format/footer.css">
<link rel="stylesheet"
				...
				<div class="searchBar">
					<form action="/BoardSearch.bo">
						<div class="searchBar-items" id="searchBar-items">
							...
							<input class="searchBar-content" name="BOARD_NAME" type="text"
