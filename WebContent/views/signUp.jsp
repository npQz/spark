        ...
        <div class="inputContents">
          <div class="inputInfo">
            ...
            <div class="inputSubtitle" id="inputSubtitle">
              주차장을 찾으시나요? <a href="/Home.bo">홈으로</a>
            </div>
            <div class="inputSubtitle inputSubtitle2">
              이미 가입하셨나요? <a href="/Signin.bo">로그인</a>
            </div>
          </div>
          <form action="/MemberJoinAction.bo" method="post" name="signUpForm">
            ...
            <div class="input-group">
              <div class="input-age">
                <div><label for="age">나이</label></div>
...
/*
  ...
  chkEmail("submitBtn", "email", "emailCmt");

  chkPw("submitBtn", "pw", "pwCmt");
*/
